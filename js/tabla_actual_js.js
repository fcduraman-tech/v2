const jugadores_actual = [
            { nombre: "Aslan", partidos: 67, goles: 71, asistencias: 34, mvp: 19 },
            { nombre: "Dawins", partidos: 60, goles: 48, asistencias: 39, mvp: 16 },
            { nombre: "Wenderly", partidos: 52, goles: 53, asistencias: 19, mvp: 7 },
            { nombre: "Eliant", partidos: 43, goles: 36, asistencias: 22, mvp: 5 },
            { nombre: "Sebastián", partidos: 64, goles: 38, asistencias: 20, mvp: 18 },
            { nombre: "Jeremy", partidos: 46, goles: 25, asistencias: 14, mvp: 3 },
            { nombre: "Daniel", partidos: 44, goles: 20, asistencias: 20, mvp: 7 },
            { nombre: "Joelfry", partidos: 54, goles: 28, asistencias: 15, mvp: 7 },
            { nombre: "Nicolás", partidos: 63, goles: 13, asistencias: 19, mvp: 5 },
            { nombre: "Adonys", partidos: 41, goles: 16, asistencias: 10, mvp: 9 },
            ...
            { nombre: "Geraldo", partidos: 56, goles: 2, asistencias: 10, mvp: 7 },
            { nombre: "Christian", partidos: 15, goles: 0, asistencias: 10, mvp: 1 },
            { nombre: "Oscar", partidos: 36, goles: 5, asistencias: 1, mvp: 8 },
            { nombre: "Leo", partidos: 44, goles: 3, asistencias: 2, mvp: 4 },
