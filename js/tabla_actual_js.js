const jugadores_actual = [
            { nombre: "Aslan", partidos: 62, goles: 68, asistencias: 34, mvp: 17 },
            { nombre: "Dawins", partidos: 55, goles: 45, asistencias: 38, mvp: 16 },
            { nombre: "Wenderly", partidos: 49, goles: 52, asistencias: 19, mvp: 7 },
            { nombre: "Eliant", partidos: 40, goles: 31, asistencias: 21, mvp: 4 },
            { nombre: "Sebastián", partidos: 52, goles: 35, asistencias: 15, mvp: 18 },
            { nombre: "Jeremy", partidos: 46, goles: 25, asistencias: 14, mvp: 3 },
            { nombre: "Daniel", partidos: 43, goles: 20, asistencias: 20, mvp: 7 },
            { nombre: "Joelfry", partidos: 49, goles: 25, asistencias: 13, mvp: 7 },
            { nombre: "Nicolás", partidos: 58, goles: 13, asistencias: 19, mvp: 5 },
