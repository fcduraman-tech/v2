const jugadores_actual = [
            { nombre: "Aslan", partidos: 65, goles: 71, asistencias: 34, mvp: 18 },
            { nombre: "Dawins", partidos: 58, goles: 47, asistencias: 39, mvp: 16 },
            { nombre: "Wenderly", partidos: 50, goles: 53, asistencias: 19, mvp: 7 },
            { nombre: "Eliant", partidos: 43, goles: 36, asistencias: 22, mvp: 5 },
            { nombre: "Sebastián", partidos: 62, goles: 36, asistencias: 18, mvp: 18 },
            { nombre: "Jeremy", partidos: 46, goles: 25, asistencias: 14, mvp: 3 },
            { nombre: "Daniel", partidos: 44, goles: 20, asistencias: 20, mvp: 7 },
            { nombre: "Joelfry", partidos: 52, goles: 25, asistencias: 14, mvp: 7 },
            { nombre: "Nicolás", partidos: 61, goles: 13, asistencias: 19, mvp: 5 },
            ...
            { nombre: "Geraldo", partidos: 54, goles: 2, asistencias: 10, mvp: 6 },
