const jugadores_actual = [
            { nombre: "Aslan", partidos: 69, goles: 73, asistencias: 37, mvp: 20 },
            { nombre: "Dawins", partidos: 62, goles: 49, asistencias: 40, mvp: 16 },
            { nombre: "Wenderly", partidos: 54, goles: 56, asistencias: 19, mvp: 7 },
            { nombre: "Eliant", partidos: 45, goles: 36, asistencias: 22, mvp: 5 },
            { nombre: "Sebastián", partidos: 66, goles: 39, asistencias: 20, mvp: 20 },
            { nombre: "Jeremy", partidos: 46, goles: 25, asistencias: 14, mvp: 3 },
            { nombre: "Daniel", partidos: 44, goles: 20, asistencias: 20, mvp: 7 },
            { nombre: "Joelfry", partidos: 56, goles: 28, asistencias: 15, mvp: 8 },
            { nombre: "Nicolás", partidos: 65, goles: 14, asistencias: 19, mvp: 5 },
            { nombre: "Adonys", partidos: 43, goles: 17, asistencias: 10, mvp: 9 },
            { nombre: "Dylan", partidos: 20, goles: 11, asistencias: 10, mvp: 2 },
            { nombre: "Gari", partidos: 15, goles: 4, asistencias: 10, mvp: 3 },
            { nombre: "Welfry", partidos: 13, goles: 9, asistencias: 2, mvp: 1 },
            { nombre: "Geraldo", partidos: 58, goles: 2, asistencias: 10, mvp: 7 },
            { nombre: "Christian", partidos: 17, goles: 0, asistencias: 11, mvp: 1 },
            { nombre: "Oscar", partidos: 36, goles: 5, asistencias: 1, mvp: 8 },
            { nombre: "Leo", partidos: 46, goles: 3, asistencias: 2, mvp: 5 },
            { nombre: "Obed", partidos: 11, goles: 2, asistencias: 2, mvp: 3 },
            { nombre: "Lecnar", partidos: 42, goles: 0, asistencias: 0, mvp: 2 },
            { nombre: "Abiel", partidos: 6, goles: 0, asistencias: 2, mvp: 2 },
            { nombre: "Erick", partidos: 2, goles: 0, asistencias: 0, mvp: 0 },
            { nombre: "Niño", partidos: 2, goles: 0, asistencias: 0, mvp: 1 },
            { nombre: "Jacob", partidos: 4, goles: 1, asistencias: 0, mvp: 0 },
